...
const Payments = () => {
  ...
  Api.getUserDetails(localStorage.getItem("user"),(response)=>{
    ...
    firstnameRef.current.value = response.data.data[0]["first_name"];
    lastnameRef.current.value = response.data.data[0]["last_name"];
    emailRef.current.value =response.data.data[0]["email"];
    phoneRef.current.value= response.data.data[0]["phone"];
  })
}
  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto rounded border my-10 p-5">
      <h2 class="text-4xl font-bold mb-10 mt-8  text-center text-gray-700">Payment</h2>
      <div className="flex">
        <div
          style={{
            display:
              ...
              <fieldset class="col-span-6">
                ...
                <div class="-space-y-px bg-white rounded-lg shadow-sm">
                  <div>
                    ...
                    <input
                      class="bg-gray-100 mb-4 relative rounded-t-lg w-full focus:z-10 text-sm p-2.5 placeholder-pink-400"
                      type="text"
                      name="card-number"
                      id="card-number"
                  ...
                  <div class="flex -space-x-px">
                    <div class="flex-1 mr-4">
                      ...
                      <input
                        class="bg-gray-100 border-pink-200 relative rounded-bl-lg w-full focus:z-10 text-sm p-2.5 placeholder-gray-400"
                        type="text"
                    ...
                    <div class="flex-1">
                      ...
                      <input
                        class=" bg-gray-100 border-pink-200 relative rounded-br-lg w-full focus:z-10 text-sm p-2.5 placeholder-gray-400"
                        type="text"
                        name="card-cvc"
                        value={"238"}
                        id="card-cvc"
              ...
              <fieldset class="col-span-6">
                ...
                <div class="-space-y-px bg-white rounded-lg shadow-sm">
                  <div>
                    ...
                    <select
                      class=" bg-gray-100 border-pink-200 relative rounded-t-lg w-full focus:z-10 text-sm p-2.5"
                      id="country"
                      name="country"
                  ...
                  <div>
                    ...
                    <input
                      class="bg-gray-100 mt-5 border-pink-200 relative rounded-b-lg w-full focus:z-10 text-sm p-2.5 placeholder-pink-400"
                      type="text"
                      name="postal-code"
                      id="postal-code"
                      value={"416009"}
