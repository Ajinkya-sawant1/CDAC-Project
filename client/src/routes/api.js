...
export default class Api {
  ...
  static getUserList = (callback) => {
    Axios.get("https://the-cradle-crew.herokuapp.com/api/admin/get/users").then((response) =>
      callback(response)
    );
  };
  ...
  static getAppointedBabysitter = (callback) => {
    Axios.post("https://the-cradle-crew.herokuapp.com/api/appoint/parent", {
  ...
  static getBabysitterAppointments = (callback) => {
    Axios.post("https://the-cradle-crew.herokuapp.com/api/appoint/get", {
      username: window.localStorage.getItem("user"),
    })
      .then((response) => callback(response))
      .catch((err) => callback(err));
  ...
  static bookBabysitter = (params, callback) => {
    Axios.post("https://the-cradle-crew.herokuapp.com/api/appoint/", params)
      .then((response) => {
        callback(response);
      })
      .catch((err) => callback(err));
  ...
  static acceptAppointment = (parentUsername, meetingLink, callback) => {
    Axios.post("https://the-cradle-crew.herokuapp.com/api/appoint/accept", {
      username: window.localStorage.getItem("user"),
  ...
  static deleteAppointment = (parentUsername, callback) => {
    Axios.delete("https://the-cradle-crew.herokuapp.com/api/appoint/accept", {
      parentUsername,
      username: window.localStorage.getItem("user"),
    }).then((response) => callback(response));
  };
  ...
  static sendFeedback = (name, email, message, callback) => {
    Axios.post("https://the-cradle-crew.herokuapp.com/api/users/feedback", {
      name,
      email,
      message,
    }).then((response) => callback(response));
  ...
  static getFeedbacks = (callback) => {
    Axios.get("https://the-cradle-crew.herokuapp.com/api/users/feedback").then((response) =>
      callback(response)
    );
  };

  static editProfile = (params, callback) => {
    Axios.put("https://the-cradle-crew.herokuapp.com/api/users/profile/update", params).then(
  ...
  static deleteProfile = (username, callback) => {
    ...
    fetch("https://the-cradle-crew.herokuapp.com/api/users/profile", requestOptions)
